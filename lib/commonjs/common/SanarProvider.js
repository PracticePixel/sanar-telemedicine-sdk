...
const SanarProvider = _ref => {
  ...
  const _toggleWhiteBg = async action => {
    let source = new _sanarRtc.VirtualBackgroundSource({
      backgroundSourceType: _sanarRtc.VirtualBackgroundSourceType.Color,
      color: new _sanarRtc.Color(1, 1, 1)
    });
  ...
  const _toggleBlurBg = action => {
    let source = new _sanarRtc.VirtualBackgroundSource({
      backgroundSourceType: _sanarRtc.VirtualBackgroundSourceType.Blur,
      blur_degree: _sanarRtc.VirtualBackgroundBlurDegree.Medium
    });
