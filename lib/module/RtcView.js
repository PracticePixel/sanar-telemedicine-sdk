...
export default class RtcView extends Component {
  ...
  render() {
    ...
    if (joined) {
      ...
      }, isChatEnabled && /*#__PURE__*/React.createElement(SanarChat, {
        empId: 'uid',
      ...
      }, connecting ? /*#__PURE__*/React.createElement(Connecting, null) : /*#__PURE__*/React.createElement(RtcContainer, null, /*#__PURE__*/React.createElement(VideoFrames, {
        isLocal: intialFrame
      }))));
    } else {
      return null;
...
_defineProperty(RtcView, "contextType", SanarContext);
