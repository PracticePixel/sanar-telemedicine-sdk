...
const AnimatedImage = props => {
  ...
  const [animateCircle, setAnimateCircle] = React.useState(true); //:- Outer circle
  ...
  var outerCirRadius = React.useRef(new Animated.Value(130)).current; //:- Inner circle
  ...
  const animateOuterCircle = () => {
    ...
    Animated.parallel([Animated.timing(outerCirHeight, {
      toValue: height,
      duration: 600,
  ...
  const animateInnerCircle = () => {
    ...
    Animated.parallel([Animated.timing(innerCirHeight, {
      toValue: height,
      duration: 600,
      useNativeDriver: false
